...
1. Open F7's Objects tab and select Maps in the dropdown, then open VV on your map ![](../images/removing-clouds-1.png)
2. Find and delete the RestrictedRangeComponent ![](../images/removing-clouds-2.png)
