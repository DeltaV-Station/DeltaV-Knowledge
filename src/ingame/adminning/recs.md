...
You can open a floating window which follows a player of your choice around using the `camera <username>` command or by right-clicking a player and clicking _Admin > Open Camera_.
