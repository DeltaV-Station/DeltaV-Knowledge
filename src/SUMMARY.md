...
- [Tricks](ingame/tricks.md)
    - [Arbitrary Flatpacks](ingame/tricks/arbitrary_flatpacks.md)
    - [aGhost Shenanigans](ingame/tricks/aghost_shenanigans.md)
    - [Station Comms in a Ghost Bar](ingame/tricks/read_comms_ghostbar.md)
    - [Sending Custom Mail](ingame/tricks/custom_mail.md)
